...
- History handling defaults to reset-on-done (production behavior). Keep
  `LITE3_UNREALISTIC_HISTORY_FEED` unset unless explicitly running legacy debug experiments.
